    ...
    <div class="max-w-7xl mx-auto px-4 py-8">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
            ...
            <button wire:click="openCreate"
                ...
                class="text-white font-semibold px-5 py-2.5 rounded-xl hover:opacity-90 transition
                    flex items-center gap-2 text-sm self-start">
        ...
        <div class="relative mb-5 max-w-sm">
            ...
            <input wire:model.live.debounce.400ms="search"
                ...
                class="w-full pl-10 pr-4 py-2.5 border border-purple-200 rounded-xl text-sm
                ...
                <tbody class="divide-y divide-purple-50">
                    @forelse($products as $product)
                        <tr class="hover:bg-purple-50/30 transition">
                            ...
                            <td class="px-5 py-3">
                                <p class="font-semibold text-gray-800 max-w-[200px] truncate">
                                    {{ $product->title }}
                                </p>
                            ...
                            <td class="px-5 py-3">
                                <span style="color: #E94E77;" class="font-bold">
                            ...
                            <td class="px-5 py-3">
                                <div class="flex items-center gap-2">
                                    <button wire:click="openEdit({{ $product->id }})"
                                        class="px-3 py-1.5 text-xs rounded-lg border border-purple-200
                                            text-purple-700 hover:bg-purple-50 transition font-medium">
                                        Edit
                                    </button>
                                    <button wire:click="delete({{ $product->id }})"
                                        wire:confirm="Are you sure you want to delete '{{ $product->title }}'? This cannot be undone."
                                        class="px-3 py-1.5 text-xs rounded-lg border border-red-200
            ...
            <div class="bg-white rounded-2xl w-full max-w-lg shadow-2xl max-h-screen overflow-y-auto">
                ...
                <div class="flex items-center justify-between p-6 border-b border-purple-100">
                    ...
                    <button wire:click="$set('showModal', false)"
                        class="w-8 h-8 rounded-full bg-gray-100 hover:bg-gray-200 flex items-center
                            justify-center text-gray-500 transition text-lg leading-none">
                        ×
                    </button>
                </div>
                ...
                <div class="p-6 space-y-4">
                    ...
                    <div>
                        ...
                        <input wire:model="title" type="text" placeholder="Enter book title..."
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-2 gap-2">
                            <label class="flex items-center gap-2 p-3 rounded-xl border-2 cursor-pointer transition
                                {{ $category === 'wattpad' ? 'border-pink-400 bg-pink-50' : 'border-gray-100' }}">
                            ...
                            <label class="flex items-center gap-2 p-3 rounded-xl border-2 cursor-pointer transition
                                {{ $category === 'manga' ? 'border-blue-400 bg-blue-50' : 'border-gray-100' }}">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input wire:model="rating" type="number" step="0.1" min="0" max="5" placeholder="4.5"
                                class="w-full border border-purple-200 rounded-xl px-4 py-3 text-sm
                                    outline-none focus:border-purple-400 transition" />
                        </div>
                    </div>
                ...
                <div class="flex gap-3 p-6 border-t border-purple-100">
                    <button wire:click="save"
                        ...
                        class="flex-1 text-white font-semibold py-3 rounded-xl hover:opacity-90
                    ...
                    <button wire:click="$set('showModal', false)"
                        class="flex-1 border-2 border-purple-200 text-purple-700 font-semibold py-3
